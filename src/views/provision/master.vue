<template>
  <div id="master">
    <div class="web d-none d-mb-block">
      <div class="masterTable w-100 d-flex align-items-center flex-row cur-pointer" v-for="(item, index) in masterMsg" :key="'BT__' + index" @click="viewInfo(item)">
    ...
    <div class="phone d-block d-mb-none">
      <div class="w-100 newsInfo">
        <div class="px-20 pt-40 pb-90">
          <div class="w-100 newsInfo__card d-flex flex-row mb-15" v-for="(item, index1) in masterMsg" :key="index1" @click="goMasterInfo(item)">
        ...
        <div class="p-40">
          <div class="w-100 pos-relative d-flex align-items-start justify-content-center flex-column">
            <div class="p-10 modal__content--tag">
              <span class="d-inline-flex">碩士班</span>
            </div>
...
export default {
  ...
  methods: {
    ...
    goMasterInfo(data) {
      this.$router.push({ name: "masterInfo", params: { id: data.id } });
    },
    showfileInfo(data) {
