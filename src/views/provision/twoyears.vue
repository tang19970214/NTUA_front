<template>
  <div id="twoyears">
    <div class="web d-none d-mb-block">
      <div class="twoyearsTable w-100 d-flex align-items-center flex-row cur-pointer" v-for="(item, index) in twoyearsMsg" :key="'BT__' + index" @click="viewInfo(item)">
    ...
    <div class="phone d-block d-mb-none">
      <div class="w-100 newsInfo">
        <div class="px-20 pt-40 pb-90">
          <div class="w-100 newsInfo__card d-flex flex-row mb-15" v-for="(item, index1) in twoyearsMsg" :key="index1" @click="goTwoyearsInfo(item)">
