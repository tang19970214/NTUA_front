<template>
  <div id="bachelor">
    <div class="web d-none d-mb-block">
      <div
        class="bachelorTable w-100 d-flex align-items-center flex-row cur-pointer"
        v-for="(item, index) in bachelorMsg"
        :key="'BT__' + index"
        @click="viewInfo(item)"
      >
      ...
      <div class="w-100 newsInfo">
        <div class="px-20 pt-40 pb-90">
          <div
            ...
            v-for="(item, index1) in bachelorMsg"
            :key="index1"
            @click="goBachelorInfo(item)"
          >
