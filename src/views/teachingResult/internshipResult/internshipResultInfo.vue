<template>
  <div id="internshipResultInfo">
    <div class="d-block d-mb-none pt-70">
      <div class="internshipResultTitle w-100 d-flex align-items-center flex-row">
        <router-link class="pl-20" :to="{ name: 'internshipResult' }">
          <img src="@/assets/images/icon/arrowLeft.png" alt="" />
        </router-link>
        <PhoneTitle title="實習成果" :filterDate="false" />
      </div>
      <div class="w-100 newsInfo">
        <div class="px-20 pt-40 pb-90">
          <div class="w-100 newsInfo__card" v-for="item in internshipResultMsg" :key="item.id">
...
<style lang="scss">
#internshipResultInfo {
  .internshipResultTitle {
    a {
